...
//            new String(response.data, HttpHeaderParser.parseCharset(response.headers));
            //XLog.i("wanges", "response.headers:"+response.headers);
            XLog.i("wanges", "json:"+jsonString);
            
            //JSONObject jsonObject = new JSONObject("﻿﻿{\"ret\":0,\"data\":{\"msg\":\"success\"}}");
            return Response.success(new JSONObject(jsonString.trim()),
