 ...
 * 
 */
package com.tien.volley.imagecache;
...
import com.tien.volley.toolbox.ImageLoader;
import com.tien.volley.toolbox.ImageLoader.ImageCache;
import com.tien.volley.toolbox.ImageLoader.ImageListener;
...
public class ImageCacheManager{
    ...
    public void init(Context context, String uniqueName, int cacheSize, CompressFormat compressFormat, int quality, CacheType type){
        ...
        mImageLoader = new ImageLoader(AIApplication.getInstance().getRequestQueue(), mImageCache, mDiskImageCache);
    }
