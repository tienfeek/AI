...
public class SwipeListView extends ListView {
    ...
    */
    ...
    private final static int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 15;
    ...
    */
     ...
     */
    protected void onClickFrontView(int position, View v) {
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
            swipeListViewListener.onClickFrontView(position, v);
        }
    }
