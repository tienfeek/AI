...
package com.tien.ai.view.swipelistview;
    ...
    private void setFrontView(View frontView) {
        ...
        frontView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                XLog.i("wanges", "downPosition:"+downPosition);
            }
        });
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (MotionEventCompat.getActionMasked(motionEvent)) {
            case MotionEvent.ACTION_DOWN: {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (allowSwipe && rect.contains(x, y)) {
                        ...
                        XLog.i("wanges", "childPosition:"+childPosition +" rect:"+rect);
            ...
            case MotionEvent.ACTION_UP: {
                ...
                } else if (Math.abs(deltaX) > viewWidth / 5) {
                    swap = true;
                    swapRight = deltaX > 0;
                }
                ...
                if (deltaMode > slop && swipeCurrentAction == SwipeListView.SWIPE_ACTION_NONE && velocityY < velocityX) {
                    ...
                    if (opened.get(downPosition)) {
                        ...
                        if (swipingRight && swipeActionRight == SwipeListView.SWIPE_ACTION_DISMISS) {
                            ...
                            XLog.i("wanges", "swipingRight && swipeActionRight == SwipeListView.SWIPE_ACTION_DISMISS-"+swipeCurrentAction);
                        } else if (!swipingRight && swipeActionLeft == SwipeListView.SWIPE_ACTION_DISMISS) {
                            swipeCurrentAction = SwipeListView.SWIPE_ACTION_DISMISS;
                            XLog.i("wanges", "!swipingRight && swipeActionLeft == SwipeListView.SWIPE_ACTION_DISMISS--"+swipeCurrentAction);
                            ...
                            XLog.i("wanges", "swipingRight && swipeActionRight == SwipeListView.SWIPE_ACTION_CHOICE---"+swipeCurrentAction);
                        } else if (!swipingRight && swipeActionLeft == SwipeListView.SWIPE_ACTION_CHOICE) {
                            swipeCurrentAction = SwipeListView.SWIPE_ACTION_CHOICE;
                            XLog.i("wanges", "!swipingRight && swipeActionLeft == SwipeListView.SWIPE_ACTION_CHOICE----"+swipeCurrentAction);
                        } else {
                            swipeCurrentAction = SwipeListView.SWIPE_ACTION_REVEAL;
                            XLog.i("wanges", "else -----"+swipeCurrentAction);
                        }
